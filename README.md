...
End-to-end system: dashboard and chat talk to the API; the worker drains the document queue into Postgres and Neo4j; live updates flow back over WebSocket.

<p align="center">
  <img src="assets/fleetmind-architecture.png" alt="FleetMind architecture: React dashboard and chat over REST/WebSocket to FastAPI, backed by PostgreSQL, Redis, Neo4j, and an extraction worker" width="100%">
</p>
